...
public class RenderUtils {
    ...
    private static final int COLOR = new Color(255, 100, 100).getRGB();
    private static final Color COLOR2 = new Color(100, 100, 255);
    ...
    public static void renderLabel(Vec3 position, String name, float partialTicks) {
        FontRenderer fontrenderer = Minecraft.getMinecraft().fontRendererObj;
        EntityPlayer player = Minecraft.getMinecraft().thePlayer;

        double realX = player.lastTickPosX + (player.posX - player.lastTickPosX) * partialTicks;
        double realY = player.lastTickPosY + (player.posY - player.lastTickPosY) * partialTicks;
        double realZ = player.lastTickPosZ + (player.posZ - player.lastTickPosZ) * partialTicks;

        double x = position.xCoord - realX;
        double y = position.yCoord - realY;
        double z = position.zCoord - realZ;
    ...
    public static void drawFilledEsp(BlockPos pos) {
        try {
            ...
            GlStateManager.disableDepth();
            GlStateManager.disableLighting();
            GlStateManager.color((float) COLOR2.getRed() / 255.0f, (float) COLOR2.getGreen() / 255.0f, (float) COLOR2.getBlue() / 255.0f, (float) COLOR2.getAlpha() / 255.0f * (float) 0.3);
            ...
            RenderUtils.drawBox(box, COLOR2, true, true, 2);
            GlStateManager.enableDepth();
            GlStateManager.enableTexture2D();
            GlStateManager.disableBlend();
